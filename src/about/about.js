...
class About extends Component {
    ...
    render() {
        return (
        <div>
            <BrowserView style={{marginTop:"5.5em"}}>
                <Fade>
                    ...
                    <div className="aboutBody">
                        ...
                        <p style={{textAlign:"left"}}>As the president of the Gender and Sexuality Alliance in my senior year of high school, I was lucky enough to be offered a position at the highly esteemed Lawrence Berkeley National Labs, or Berkeley Labs. 
                        At Berkeley Labs, I worked as a Computing Sciences Summer Student Researcher within the Integrated Date Frameworks group of the Data Science and Technology Department of the Computational Research Division. 
                        There, I used the Python scientific computing library, SciPy, and specifically the NumPy and Matplotlib packages to construct advanced visualizations of high frequency weather data in order to perform quality assurance and correction of the data.</p>
                        <p style={{textAlign:"left"}}>Apart from the technical skills I picked up at Berkeley Labs, I found my passion for computer science. 
                        Working amongst Nobel laureates and observing groundbreaking science being performed every day, it was clear to me how much all of the amazing work being done relied upon the computational systems running things. 
                        After that summer, I enrolled at Humboldt State University as a Computer Science student.</p>
            ...
            <MobileView style={{marginTop:"5.5em"}}>
                <Fade>
                    <div style={{textAlign:"center"}}>
                        <Media object src={Project_collage} alt="projects" style={{maxWidth:"98vw", maxHeight:"40vh"}}/>
                    </div>
                    ...
                    <div className="aboutBody">
                        ...
                        <p style={{textAlign:"left"}}>In school, I learned the fundamentals of programming with C++, tackled software engineering of both web and mobile applications, and got to experiment with advanced topics such as data mining and React.js. 
                        Two events in my university years have had major affects on me as a developer.</p>
