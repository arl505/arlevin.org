...
{mobile 
    ...
    <Media object src={Humboldt} alt="Humboldt State" style={{display:"inline", width:"40vw"}}/>
                        ...
                        <div style={{textAlign:"center", marginBottom:"1em", marginTop:"2em"}}>
                            ...
                            {mobile &&
                            (<p style={{textAlign:"left", marginBottom:"1.5em"}}>First, taking a mobile applications course geared towards Android–and then teaching the course with Codepath.org–left me with a passion for mobile app development. Secondly, taking on a real world non-profit startup client and working as a web engineer with the most modern technologies left me excited to explore further possibilities. The web app was built with a MERN stack, or a MongoDB, Express.js, React.js, and Node.js stack. All of this history culminates in my extreme hunger to develop reliable, responsive, and revolutionary applications that users, such as the scientists at Berkeley Labs, can depend on.</p>
                            )}  
                        </div>
                    </div>
            </Fade>
